				...
				<div class="panel panel-default">
						...
						<div class="row">
							...
							<form class="bs-example bs-example-form col-md-5" role="form" style="margin: 20px 0 10px 0;" action="/admin/selectCourse" id="form1" method="post">
								<div class="input-group">
									<input type="text" class="form-control" placeholder="请输入姓名" name="findByName" id="findByName" value="${sessionScope.findCourseByName}">
					...
					<div class="panel-footer">
						<div class="pull-left">
							<div class="form-group form-inline">
								总共${selectCourseInfo.pages} 页，共${selectCourseInfo.total} 条数据。 每页
					...
					<div class="panel-footer">
						<nav style="text-align: center">
							<ul class="pagination">
								<li>
									<a aria-label="Previous" href="${pageContext.request.contextPath}/admin/selectCourse?page=1&pageSize=${selectCourseInfo.pageSize}">首页</a>
								</li>
								<li><a href="${pageContext.request.contextPath}/admin/selectCourse?page=${selectCourseInfo.pageNum-1}&pageSize=${selectCourseInfo.pageSize}">上一页</a></li>

								<c:forEach begin="1" end="${selectCourseInfo.pages}" var="i">
									<c:if test="${i==selectCourseInfo.pageNum}">
										<li><a style="background-color: #2aabd2" href="${pageContext.request.contextPath}/admin/selectCourse?page=${i}&pageSize=${selectCourseInfo.pageSize}">${i}</a></li>
									</c:if>
									<c:if test="${i!=selectCourseInfo.pageNum}">
										<li><a href="${pageContext.request.contextPath}/admin/selectCourse?page=${i}&pageSize=${selectCourseInfo.pageSize}">${i}</a></li>
									</c:if>
								</c:forEach>

								<li><a href="${pageContext.request.contextPath}/admin/selectCourse?page=${selectCourseInfo.pageNum+1}&pageSize=${selectCourseInfo.pageSize}">下一页</a></li>
								<li>
									<a href="${pageContext.request.contextPath}/admin/selectCourse?page=${selectCourseInfo.pages}&pageSize=${selectCourseInfo.pageSize}" aria-label="Next">尾页</a>
								</li>
							</ul>
						</nav>
					</div>
